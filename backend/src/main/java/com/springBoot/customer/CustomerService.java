...
import com.springBoot.exception.DuplicateResourceException;
import com.springBoot.exception.RequestValidationException;
import com.springBoot.exception.ResourceNotFoundException;
import com.springBoot.s3.S3Buckets;
import com.springBoot.s3.S3Service;
...
public class CustomerService {
    ...
    public byte[] getCustomerProfileImage(Integer customerId) {
        ...
        // check if profileImageID is empty
        if (customer.profileImageId().isBlank()) {
            throw new ResourceNotFoundException("customer with id [%s] profile not found".formatted(customerId));
        }
